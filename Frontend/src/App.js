...
function App() {
  ...
  const handleVisit=(mobile) => { 
    ...
    const [loginStatus, setLoginStatus] = useState(localStorage.getItem("isLogin"))
    const handleLogAndSign=()=>{
      const setLog = localStorage.getItem("isLogin");
      if(setLog === "true"){
        setLoginStatus(setLog);
      }
    }
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/login" element={<Login handleLogAndSign = {handleLogAndSign} loginStatus = {loginStatus} />}/>
        <Route path="/signup" element={<Signup handleLogAndSign = {handleLogAndSign} loginStatus = {loginStatus} />}/>
        <Route path="/vivopage">
        ...
        <Route path="/orderPage" element={<OrderPage individualData={individualData}/>}/>
