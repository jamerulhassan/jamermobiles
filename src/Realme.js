...
const Realme = ({handleVisit}) => {
  ...
  const realmePhones=[
    {id:1,phone:realmePhoneOne},
    {id:2,phone:realmePhoneTwo},
    {id:3,phone:realmePhoneThree},
    {id:4,phone:realmePhoneFour},
    {id:5,phone:realmePhoneFive},
    {id:6,phone:realmePhoneSix},
    {id:7,phone:realmePhoneSeven},
    {id:8,phone:realmePhoneEigth}]
  return (
    <main>
      <section>
        {
          realmePhones.map(phone=>(
