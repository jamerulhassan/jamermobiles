        ...
        <section className="MobilePhoneList">
            ...
            <figure className='mobile__figure figure2'>
              ...
              <figcaption className='mobile__figurecaption figurecaption2'>
                <h1>Apple iPhone 16 Plus</h1>
                <p>8GB RAM | 256 GB ROM</p>
                <p>17.02 cm (6.7 inch) Super Retina XDR Display</p>
                <p>48MP + 12MP | 12MP Front Camera</p>
                <p>4674 mAh Battery</p>
                <p>A18 Chip, 6 Core Processor Processor</p>
              </figcaption>
            ...
            <figure className='mobile__figure figure3'>
              ...
              <figcaption className='mobile__figurecaption figurecaption3'>
                ...
                <p>8GB RAM | 128 GB ROM</p>
                <p>16.0 cm (6.3 inch) Super Retina XDR Display</p>
                <p>48MP + 48MP + 12MP | 12MP Front Camera</p>
                <p>3582 mAh Battery</p>
                <p>A18 Pro Chip, 6 Core Processor Processor</p>
              </figcaption>
            ...
            <figure className='mobile__figure figure5'>
                ...
                <figcaption className='mobile__figurecaption figurecaption5'>
                  ...
                  <p>6GB RAM | 256 GB ROM</p>
                  <p>17.02 cm (6.7 inch) Super Retina XDR Display</p>
                  <p>48MP + 12MP | 12MP Front Camera</p>
                  <p>4383 mAh Battery</p>
                  <p>A16 Bionic Chip, 6 Core Processor Processor</p>
                </figcaption>
            ...
            <figure className='mobile__figure figure6'>
                ...
                <figcaption className='mobile__figurecaption figurecaption6'>
                  ...
                  <p>8GB RAM | 512 GB ROM</p>
                  <p>17.02 cm (6.7 inch) Super Retina XDR Display</p>
                  <p>48MP + 12MP + 12MP | 12MP Front Camera</p>
                  <p>4383 mAh Battery</p>
                  <p>A17 Pro Chip, 6 Core Processor Processor</p>
                </figcaption>
            ...
            <figure className='mobile__figure figure7'>
                ...
                <figcaption className='mobile__figurecaption figurecaption7'>
                  ...
                  <p>8GB RAM | 1 TB ROM</p>
                  <p>15.49 cm (6.1 inch) Super Retina XDR Display</p>
                  <p>48MP + 12MP + 12MP | 12MP Front Camera</p>
                  <p>3290 mAh Battery</p>
                  <p>A17 Pro Chip, 6 Core Processor Processor</p>
                </figcaption>
